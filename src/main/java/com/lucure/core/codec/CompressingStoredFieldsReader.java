...
import static com.lucure.core.codec.CompressingStoredFieldsWriter.BYTE_ARR;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.CODEC_SFX_DAT;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.CODEC_SFX_IDX;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.NUMERIC_DOUBLE;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.NUMERIC_FLOAT;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.NUMERIC_INT;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.NUMERIC_LONG;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.STRING;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.TYPE_BITS;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.TYPE_MASK;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.VERSION_BIG_CHUNKS;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.VERSION_CURRENT;
import static com.lucure.core.codec.CompressingStoredFieldsWriter.VERSION_START;
...
public final class CompressingStoredFieldsReader extends StoredFieldsReader {
  ...
  private static void readField(
          DataInput in, StoredFieldVisitor visitor, FieldInfo info, int bits, ColumnVisibility cv) throws IOException {
    ...
    switch (bits & TYPE_MASK) {
      ...
      case NUMERIC_INT:
          ...
          if(hasAccess) {
              visitor.intField(info, intValue);
          }
        break;
      case NUMERIC_FLOAT:
          float floatValue = Float.intBitsToFloat(in.readInt());
          if(hasAccess) {
              visitor.floatField(info, floatValue);
          }
        break;
      case NUMERIC_LONG:
          long longValue = in.readLong();
          if(hasAccess) {
              visitor.longField(info, longValue);
          }
        break;
      case NUMERIC_DOUBLE:
          double doubleValue = Double.longBitsToDouble(in.readLong());
          if(hasAccess) {
              visitor.doubleField(info, doubleValue);
          }
        break;
      default:
  ...
  public void visitDocument(int docID, StoredFieldVisitor visitor)
    ...
    for (int fieldIDX = 0; fieldIDX < numStoredFields; fieldIDX++) {
      ...
      switch(visitor.needsField(fieldInfo)) {
        case YES:
          readField(documentInput, visitor, fieldInfo, bits, cv);
          break;
        case NO:
