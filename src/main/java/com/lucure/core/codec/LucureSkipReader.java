 ...
 *
 */
final class LucureSkipReader extends MultiLevelSkipListReader {
  ...
  public LucureSkipReader(
    IndexInput skipStream, int maxSkipLevels, int blockSize, boolean hasPos,
