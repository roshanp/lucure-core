 ...
 *
 */
final class LucureSkipWriter extends MultiLevelSkipListWriter {
  ...
  public LucureSkipWriter(
    int maxSkipLevels, int blockSize, int docCount, IndexOutput docOut,
    IndexOutput posOut, IndexOutput payOut) {
